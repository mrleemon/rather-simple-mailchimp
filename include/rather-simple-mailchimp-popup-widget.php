...
class Rather_Simple_Mailchimp_Popup_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array( 'classname' => 'rather_simple_mailchimp_popup_widget', 'description' => __( 'A simple Mailchimp popup widget', 'rather-simple-mailchimp' ) );
...
add_action( 'widgets_init', function() { return register_widget( 'Rather_Simple_Mailchimp_Popup_Widget' ); } );